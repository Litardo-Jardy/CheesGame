Public Class LGDama
    ...
    Public Sub damaMove(image As PictureBox, CoorX As Integer, CoorY As Integer, Tablero As Panel(,))
            ...
            If Coor.isLife Then
                If selectTurn.turn = Coor.IsColor Then
                    If CoorX < 8 Or CoorX > -1 Or CoorY < 8 Or CoorY > -1 Then
                        ...
                        'Evalua comer X a la derecha - Recto
                        ...
                        'Evalua comer X a la derecha - Diagonal
                        For i = 1 To (CoorX - Coor.X)
                            If (Coor.X + i) < 8 And (Coor.X + i) > -1 And (Coor.Y + i) < 8 And (Coor.Y + i) > -1 Then
                        ...
                        'Evalua comer Y hacia arriba - Recto
                        ...
                        'Evalua comer Y hacia arriba - Diagonal
                        ...
                        'Evalua comer Y hacia abajo - Recto
                        For i = 1 To (Coor.Y - CoorY)
                            If (Coor.Y - i) < 8 And (Coor.Y - i) > -1 Then
                                Dim isImg2 = isImage(Tablero, Coor.X, Coor.Y - i)
                        ...
                        'Evalua comer X a la izquierda - Diagonal
                        For i = 1 To (Coor.X - CoorX)
                            If (Coor.X - i) < 8 And (Coor.X - i) > -1 And (Coor.Y + i) < 8 And (Coor.Y + i) > -1 Then
                                Dim isImg2 = isImage(Tablero, Coor.X - i, Coor.Y + i)
                        ...
                        'Evalua comer Y hacia abajo - Diagonal
                        For i = 1 To (Coor.Y - CoorY)
                            If (Coor.Y - i) < 8 And (Coor.Y - i) > -1 And (Coor.X - i) < 8 And (Coor.X - i) > -1 Then
                                Dim isImg2 = isImage(Tablero, Coor.X - i, Coor.Y - i)
                        ...
                        If isValidMove Then
                            If isImg Then
                                ...
                                If Coor.IsColor <> Img.IsColor Then
                                    ...
                                    globalInstancias.recordMessage(2, "de la dama")
                                End If
                            Else
                                CP.updateValueCapturePassing(False)
                                Tablero(CoorX, CoorY).Controls.Add(image)
                            ...
                            End If
                        Else
                            globalInstancias.recordMessage(1, "The queen's")
                        End If
                    End If
                End If
            End If
